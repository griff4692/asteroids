(function () {
  ...
  Game.prototype.endGame = function () {
    ...
    this.points = 0;
    this.lives = Game.LIVES;
    this.renderStartOverText(oldPoints);
  };
  ...
  Game.prototype.renderNewGameText = function(startDimY) {
    var startDimY = startDimY || 200;
    this.ctx.font = "42px VectorBattle";
    this.ctx.strokeStyle = 'white';
    this.ctx.fillStyle = 'white';
    this.ctx.fillText("Press Spacebar to", 125, startDimY);
    this.ctx.fillText("Start a New Game!", 125, startDimY + 100);
  };

  Game.prototype.renderStartOverText = function (points) {
    this.renderNewGameText(300);
    this.ctx.font = "42px VectorBattle";
    this.ctx.strokeStyle = 'white';
    this.ctx.fillStyle = 'white';
    this.ctx.fillText(points + " Points", 250, 200);
  };
